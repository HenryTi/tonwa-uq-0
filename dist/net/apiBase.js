...
exports.ApiBase = exports.refetchApi = void 0;
function refetchApi(channel, url, options, resolve, reject) {
...
var ApiBase = /** @class */ (function () {
    function ApiBase(net, path) {
        this.net = net;
        this.path = path || '';
    }
    ApiBase.prototype.xcall = function (caller) {
        return __awaiter(this, void 0, void 0, function () {
            var channel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        channel = _a.sent();
                        return [4 /*yield*/, channel.xcall(this.path, caller)];
